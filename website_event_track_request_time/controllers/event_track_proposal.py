...
class RequestEventTrackController(EventTrackControllerAdvanced):
    ...
    def _get_event_track_proposal_form_values(self, event, **post):
        values = super(RequestEventTrackController, self)._get_event_track_proposal_form_values(event, **post)
    ...
    def _get_event_track_proposal_post_values(self, event, **post):
        values = super(RequestEventTrackController, self)._get_event_track_proposal_post_values(event, **post)
