...
class EventEvent(models.Model):
    ...
    notification_sent = fields.Boolean(string="Notification Sent", default=False, copy=False)
    ...
    def _notify_group_users(self):
        group = self.env.ref('event_active_notify.group_event_notifications', raise_if_not_found=False)
        template = self.env.ref('event_active_notify.event_activation_internal_group_mail', raise_if_not_found=False)
