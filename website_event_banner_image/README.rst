...
* Note: backend based banner image will always take precedence over a banner
  image that may have been set manually via the website builder. To show the
  website builder based image, you would need to delete the event's backend image.
* For use cases where you expect to be using the website builder to manage the
  event images, it's not recommended to install this module.
...
- No optimization for handling multiples of the same image. Each image is
  uploaded and handled as a new image.
