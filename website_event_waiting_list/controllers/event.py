...
class WebsiteEventControllerWaiting(WebsiteEventController):
    ...
    def registration_new(self, event, **post):
        ...
        if 'waiting_list_registration' in post:
            ...
            return super(WebsiteEventControllerWaiting, self).registration_new(event, **post)
    ...
    def registration_confirm(self, event, **post):
        ...
        if not event.waiting_list and any(event_ticket.seats_limited and event_ticket.seats_available < len(registrations_data) for event_ticket in event_tickets):
