...
class Event(models.Model):
    ...
    announcement_sent = fields.Boolean(
        ...
        default=False,
        copy=False,
        help="Indicates if an announcement email has already been sent for this event to contacts who are interested in this event's tags.",
    )
    ...
    def _send_event_notifications(self):
        ...
        for event in events:
            ...
            mail_template = self.env.ref("event_notification_subscription.tag_based_notification_mail")
